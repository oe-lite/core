...
# Official fixes
SRC_URI += "http://ymorin.is-a-geek.org/download/crosstool-ng/01-fixes/1.8.0/000-cc_gcc_with_static_ppl_correctly_link_with_libm.patch"
SRC_URI += "http://ymorin.is-a-geek.org/download/crosstool-ng/01-fixes/1.8.0/001-complibs_cloog_with_static_ppl_correctly_link_with_libm.patch"

# Canadian cross fixes by Martin Gaarde Lund
SRC_URI += "file://gcc-host-libstdcxx.patch"
SRC_URI += "file://cloog-host-libstdcxx.patch"
SRC_URI += "file://glibc-2.9-typedef-caddr.patch"

# GCC 4.5.1 patch by Arnaud Lacombe
SRC_URI += "file://gcc-4.5.1.patch"

# MinGW sysroot headers patch by Esben Haabendal
SRC_URI += "file://mingw-sysroot-headers-dir.patch"
